...
character = gollum.read() #reading file,converted to strings(one single string!)
#print(character)
print(len(character))
print(character[:35])#prints a string
...
print(charset)
print(len(charset))
words = charset.split()#word by word
print(words)
print(len(words))
"""
...
#a better version
#this will extract email only if there is a 'Form' in the beginning
"""
import re
x = "From stephen.marquard@uct.ac.za Sat Jan  5 09:14:16 2008"
...
<person>
    ...
    <phone type="int">01729327784</phone>
    <email hide="yes"/>
</person>
'''
